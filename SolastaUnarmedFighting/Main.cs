...
namespace SolastaUnarmedFighting
{
    public class Main
    {
        ...
        {
            DirectoryInfo directoryInfo = new DirectoryInfo($@"{UnityModManager.modsPath}/SolastaUnarmedFighting");
            FileInfo[] files = directoryInfo.GetFiles($"Translations-??.txt");

            foreach (var file in files)
            {
                var filename = $@"{UnityModManager.modsPath}/SolastaUnarmedFighting/{file.Name}";
        ...
        internal static void ModEntryPoint()
        {
            ...
            //
            skeleton.GuiPresentation.Title = "SolastaUnarmedFighting/&FancySkeletonTitle";
            skeleton.GuiPresentation.Description = "SolastaUnarmedFighting/&FancySkeletonDescription";
        }
    }
}
